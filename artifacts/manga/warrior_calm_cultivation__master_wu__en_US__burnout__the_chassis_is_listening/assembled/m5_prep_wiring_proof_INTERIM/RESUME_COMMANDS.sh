#!/usr/bin/env bash
# M5-prep Pearl Star resume — warrior_calm_cultivation__master_wu__en_US__burnout__the_chassis_is_listening
...
BANK="artifacts/manga/warrior_calm_cultivation__master_wu__en_US__burnout__the_chassis_is_listening/image_bank"
...
echo "    --manifest artifacts/manga/warrior_calm_cultivation__master_wu__en_US__burnout__the_chassis_is_listening/assembly_manifests/<real_manifest>.yaml \\
echo "    --out-dir artifacts/manga/warrior_calm_cultivation__master_wu__en_US__burnout__the_chassis_is_listening/assembled/<real_name>/ --strip --bubbles"
