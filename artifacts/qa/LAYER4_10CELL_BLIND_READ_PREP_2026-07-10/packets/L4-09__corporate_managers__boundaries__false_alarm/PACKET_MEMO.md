...
## Readable artifacts
- `book.txt`: 15,033 words, 87,493 bytes, sha256 `ac636baf6fb8…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__boundaries__false_alarm.epub` (46,099 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__boundaries__false_alarm.epub`
...
- way_stream_sanctuary__corporate_managers__boundaries__false_alarm.epub
- assembly_trace.json (EPUB-derived + wave10 provenance; honest about missing render-dir)
- quality_summary.json
- enrichment_provenance.json
- PROVENANCE.json
- PACKET_MEMO.md
- register_gate_report.json: not retained for this engine; matrix register_PASS is the queue evidence
