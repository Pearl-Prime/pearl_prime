...
## Readable artifacts
- `book.txt`: 15,000 words, 88,282 bytes, sha256 `183120020bc1…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__anxiety__shame.epub` (46,365 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__anxiety__shame.epub`
...
- way_stream_sanctuary__corporate_managers__anxiety__shame.epub
