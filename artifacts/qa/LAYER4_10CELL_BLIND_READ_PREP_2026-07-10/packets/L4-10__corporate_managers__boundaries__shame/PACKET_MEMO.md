...
## Readable artifacts
- `book.txt`: 14,552 words, 84,822 bytes, sha256 `1ddf4705a3a3…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__boundaries__shame.epub` (45,106 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__boundaries__shame.epub`
...
- way_stream_sanctuary__corporate_managers__boundaries__shame.epub
