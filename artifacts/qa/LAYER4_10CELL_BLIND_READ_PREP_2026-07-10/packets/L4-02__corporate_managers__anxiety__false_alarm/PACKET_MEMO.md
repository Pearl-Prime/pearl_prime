...
## Readable artifacts
- `book.txt`: 14,978 words, 88,500 bytes, sha256 `e6b92bc60114…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__anxiety__false_alarm.epub` (46,331 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__anxiety__false_alarm.epub`
...
- way_stream_sanctuary__corporate_managers__anxiety__false_alarm.epub
