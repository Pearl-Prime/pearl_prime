...
## Readable artifacts
- `book.txt`: 15,748 words, 93,232 bytes, sha256 `fd9921e51330…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__anxiety__overwhelm.epub` (47,887 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__anxiety__overwhelm.epub`
...
- way_stream_sanctuary__corporate_managers__anxiety__overwhelm.epub
