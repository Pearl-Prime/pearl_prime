...
## Readable artifacts
- `book.txt`: 15,465 words, 90,991 bytes, sha256 `2e0f6e1c6e50…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__anxiety__comparison.epub` (47,545 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__anxiety__comparison.epub`
...
- way_stream_sanctuary__corporate_managers__anxiety__comparison.epub
