...
## Readable artifacts
- `book.txt`: 15,002 words, 88,499 bytes, sha256 `b278d90586d8…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__anxiety__watcher.epub` (45,818 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__anxiety__watcher.epub`
...
- way_stream_sanctuary__corporate_managers__anxiety__watcher.epub
