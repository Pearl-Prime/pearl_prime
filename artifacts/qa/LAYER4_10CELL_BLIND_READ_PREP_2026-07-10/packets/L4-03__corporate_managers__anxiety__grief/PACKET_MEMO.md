...
## Readable artifacts
- `book.txt`: 15,670 words, 91,953 bytes, sha256 `2a0fb16e5beb…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__anxiety__grief.epub` (47,702 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__anxiety__grief.epub`
...
- way_stream_sanctuary__corporate_managers__anxiety__grief.epub
