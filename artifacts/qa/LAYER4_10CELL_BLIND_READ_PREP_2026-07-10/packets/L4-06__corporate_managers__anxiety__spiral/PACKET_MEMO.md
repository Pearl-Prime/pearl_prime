...
## Readable artifacts
- `book.txt`: 15,228 words, 89,868 bytes, sha256 `54b0aa6ea4ac…`
- EPUB copy: `way_stream_sanctuary__corporate_managers__anxiety__spiral.epub` (46,551 bytes) — also tracked at `artifacts/epubs/way_stream_sanctuary/way_stream_sanctuary__corporate_managers__anxiety__spiral.epub`
...
- way_stream_sanctuary__corporate_managers__anxiety__spiral.epub
