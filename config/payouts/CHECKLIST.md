...
| 5 | KDP store / royalty reference (research) | `kdp_store_royalty_reference.yaml` |
| 6 | China digital tax / withholding (research) | `cn_digital_tax_withholding_reference.yaml` |
...
## 6. China digital tax / withholding (research only — PR-RI-006)

- [ ] Skim `config/payouts/cn_digital_tax_withholding_reference.yaml` — excerpted China VAT / withholding bullets from `artifacts/research/web_search_gap_fill_2026_03_23.md`. **Not** tax or legal advice; see `config/localization/tw_cn_distribution_compliance.yaml` for TW/CN platform and ISBN (CSBN) context from the same research file.
