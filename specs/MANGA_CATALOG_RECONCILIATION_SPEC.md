...
**Status:** ✅ EXECUTED (2026-04-26 → 2026-05) — Phase 2X landed via PRs #693/#696 (2X.4 atomic: schema flip + 848 stale YAML retire + regen) · #698 (2X.4b book_plans) · #699 (2X.5) · #700 (2X.6 docs) · #737 (schema-constant align). **Live SSOT = 1,350 `series_plan.yaml` across 5 locales** (`config/source_of_truth/manga_series_plans/{en_US,ja_JP,ko_KR,zh_CN,zh_TW}/`) + 18,900 `book_plan.yaml`. The pre-execution counts throughout this spec (132 stale / ~1,110 / ~1,195 / 1,410 series; ~16,730 chapters) are HISTORICAL planning projections retained for the reconciliation reasoning — **not** current counts. This spec did NOT reconcile `brand_genre_allocation.yaml`, `market_catalog_registry.yaml`, `catalog_generation_config.yaml`, or `manga_profiles/` (still un-reconciled). Render authority is now `docs/specs/MANGA_V5_LAYERED_ARCHITECTURE.md` (V5.1, 2026-05-20).
