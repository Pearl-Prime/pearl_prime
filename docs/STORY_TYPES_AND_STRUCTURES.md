<!-- RESTORED 2026-07-03: canonical story authority recovered git-first from b0ff1ca0ec^ (deleted by #339 "clean root directory" as non-production; originally lived at repo root). Verbatim content; re-homed to docs/ per this doc's own declared Path. -->
