...
# Lane 01 — CLI Audit: Core Spine Orchestration
...
STARTUP_RECEIPT
AGENT:              Pearl_Prime
TASK:               CLI command audit + reference doc — Core Spine Orchestration
PROJECT_ID:         proj_cli_command_audit_20260722
SUBSYSTEM:          core_pipeline
AUTHORITY_DOCS:     docs/PEARL_PRIME_WHOLE_WORKFLOW_HARDENING_SPEC.md;docs/PEARL_PRIME_BESTSELLER_WRITING_OVERLAY_SPEC.md;specs/PHOENIX_ARC_FIRST_CANONICAL_SPEC.md
READ_PATH_COMPLETE: yes
WRITE_SCOPE:        docs/cli_reference/core_spine_orchestration.md; docs/cli_reference/findings/core_spine_orchestration_FINDINGS.tsv; one row in artifacts/coordination/ACTIVE_WORKSTREAMS.tsv
...
PROVENANCE:         research: NONE (documentation/audit task); documents: docs/PEARL_PRIME_WHOLE_WORKFLOW_HARDENING_SPEC.md;docs/PEARL_PRIME_BESTSELLER_WRITING_OVERLAY_SPEC.md;specs/PHOENIX_ARC_FIRST_CANONICAL_SPEC.md; builds_on: N/A; inventory: UNCHANGED — read-only audit, zero code changes
BLOCKERS:           none known
READY_STATUS:       ready
```
...
```
git fetch origin
git checkout -b agent/cli-audit-core_spine_orchestration-20260722 origin/main
gh pr list --state open --search "cli_reference core_spine_orchestration"
```
...
1. `docs/cli_reference/core_spine_orchestration.md` — one row/section per command: path, one-line
...
2. `docs/cli_reference/findings/core_spine_orchestration_FINDINGS.tsv` — machine-readable, columns:
...
Open a PR titled `docs(cli-audit): core_spine_orchestration CLI reference + findings`. Merge it yourself
...
CLOSEOUT_RECEIPT
AGENT:          Pearl_Prime
TASK:           CLI command audit — Core Spine Orchestration
COMMIT_SHA:     <full merge SHA>
FILES_WRITTEN:  docs/cli_reference/core_spine_orchestration.md; docs/cli_reference/findings/core_spine_orchestration_FINDINGS.tsv
FILES_READ:     <authority docs actually opened>
PROVENANCE:     research: NONE; documents: docs/PEARL_PRIME_WHOLE_WORKFLOW_HARDENING_SPEC.md;docs/PEARL_PRIME_BESTSELLER_WRITING_OVERLAY_SPEC.md;specs/PHOENIX_ARC_FIRST_CANONICAL_SPEC.md; builds_on: N/A; inventory: UNCHANGED
STATUS:         completed | partial | blocked
HANDOFF_TO:     Pearl_PM (synthesis lane 13)
NEXT_ACTION:    <if partial/blocked: exact resume point>
```

Signal token: `CLI_AUDIT_CORE_SPINE_ORCHESTRATION_COMPLETE: <n_commands> commands, <n_flagged> flagged, SHA <full_sha>`
