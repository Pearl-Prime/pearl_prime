...
# Lane 10 — CLI Audit: Brand Onboarding Integrations
...
STARTUP_RECEIPT
AGENT:              Pearl_Int
TASK:               CLI command audit + reference doc — Brand Onboarding Integrations
PROJECT_ID:         proj_cli_command_audit_20260722
SUBSYSTEM:          brand_admin
AUTHORITY_DOCS:     BRAND_ADMIN_CANONICAL_PACKAGE.md;docs/INTEGRATION_CREDENTIALS_REGISTRY.md;skills/pearl-int/SKILL.md
READ_PATH_COMPLETE: yes
WRITE_SCOPE:        docs/cli_reference/brand_onboarding_integrations.md; docs/cli_reference/findings/brand_onboarding_integrations_FINDINGS.tsv; one row in artifacts/coordination/ACTIVE_WORKSTREAMS.tsv
...
PROVENANCE:         research: NONE (documentation/audit task); documents: BRAND_ADMIN_CANONICAL_PACKAGE.md;docs/INTEGRATION_CREDENTIALS_REGISTRY.md;skills/pearl-int/SKILL.md; builds_on: N/A; inventory: UNCHANGED — read-only audit, zero code changes
BLOCKERS:           none known
READY_STATUS:       ready
```
...
```
git fetch origin
git checkout -b agent/cli-audit-brand_onboarding_integrations-20260722 origin/main
gh pr list --state open --search "cli_reference brand_onboarding_integrations"
```
...
Files under: `scripts/brand/ (8 files), scripts/onboarding/ (10 files), scripts/integrations/ (8 files)`

## Lane-specific caution

scripts/integrations/ contains live-credential-adjacent CLIs (e.g. Metricool client/status per the registry) — documenting them is fine (this is a read-only audit), but do not execute any CLI flag that would perform a live write; --dry-run or --help only.
...
1. `docs/cli_reference/brand_onboarding_integrations.md` — one row/section per command: path, one-line
...
2. `docs/cli_reference/findings/brand_onboarding_integrations_FINDINGS.tsv` — machine-readable, columns:
...
Open a PR titled `docs(cli-audit): brand_onboarding_integrations CLI reference + findings`. Merge it yourself
...
CLOSEOUT_RECEIPT
AGENT:          Pearl_Int
TASK:           CLI command audit — Brand Onboarding Integrations
COMMIT_SHA:     <full merge SHA>
FILES_WRITTEN:  docs/cli_reference/brand_onboarding_integrations.md; docs/cli_reference/findings/brand_onboarding_integrations_FINDINGS.tsv
FILES_READ:     <authority docs actually opened>
PROVENANCE:     research: NONE; documents: BRAND_ADMIN_CANONICAL_PACKAGE.md;docs/INTEGRATION_CREDENTIALS_REGISTRY.md;skills/pearl-int/SKILL.md; builds_on: N/A; inventory: UNCHANGED
STATUS:         completed | partial | blocked
HANDOFF_TO:     Pearl_PM (synthesis lane 13)
NEXT_ACTION:    <if partial/blocked: exact resume point>
```

Signal token: `CLI_AUDIT_BRAND_ONBOARDING_INTEGRATIONS_COMPLETE: <n_commands> commands, <n_flagged> flagged, SHA <full_sha>`
