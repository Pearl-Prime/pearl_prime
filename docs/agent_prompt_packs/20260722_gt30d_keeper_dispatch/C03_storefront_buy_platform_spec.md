# C03 — Claude Spec Lane (I034)

EXECUTE. Act as Pearl_Architect on **Claude**.

## Goal

Author books+audiobooks buy-platform spec. Snipcart/Stripe are operator-gated deps — name them; do not require live keys. No code.

**Target path:** `docs/specs/PEARL_STOREFRONT_BUY_PLATFORM_V1_SPEC.md`
...
`artifacts/coordination/handoffs/gt30d_c03_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-c03-spec-terminal=<sha-or-blocked>
NEXT_ACTION=
```
