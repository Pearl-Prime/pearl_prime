# D07 — Cursor Dev Lane (I029/I043) [SPEC-GATED]

EXECUTE. Act as Pearl_Dev on **Cursor**.

## Gate

Do not start until `C02` closeout shows `gt30d-c02-spec-terminal=<sha>`.

## Goal

Lettering/bubble + proof hooks per C02 bar packet. Stop at first systemic blocker. Do not fake bar packet completion.
...
`artifacts/coordination/handoffs/gt30d_d07_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-d07-code-terminal=<sha-or-blocked>
NEXT_ACTION=
```
