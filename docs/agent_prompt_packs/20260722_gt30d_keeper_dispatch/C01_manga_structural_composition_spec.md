# C01 — Claude Spec Lane (I042)

EXECUTE. Act as Pearl_Architect on **Claude**.

## Goal

Author MVP spec: support surfaces, contact regions, relation checks, acceptance layers (ABSENT→PROVEN-AT-BAR). Cite manga vision-conformance doctrine. End with Cursor-may-implement checklist (smoke/pilot only).

**Target path:** `docs/specs/MANGA_STRUCTURAL_COMPOSITION_MVP_V1_SPEC.md`
...
`artifacts/coordination/handoffs/gt30d_c01_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-c01-spec-terminal=<sha-or-blocked>
NEXT_ACTION=
```
