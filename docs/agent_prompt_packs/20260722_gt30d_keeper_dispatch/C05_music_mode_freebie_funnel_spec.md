# C05 — Claude Spec Lane (I026)

EXECUTE. Act as Pearl_Architect on **Claude**.

## Goal

Spec freebie selection driven by brand_wizard YAML + musician_reflections_survey YAML (not hardcoded). Reuse `docs/agent_prompt_packs/20260721_music_mode_wizard_to_pipeline_wiring/` — do not greenfield.

**Target path:** `docs/specs/MUSIC_MODE_FREEBIE_FUNNEL_V1_SPEC.md`
...
`artifacts/coordination/handoffs/gt30d_c05_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-c05-spec-terminal=<sha-or-blocked>
NEXT_ACTION=
```
