# D02 — Cursor Dev Lane (I032)

EXECUTE. Act as Pearl_Dev on **Cursor**. Depends on **W0 only**.

## Goal

Explicit angle_id registry join on catalog variation path; missing angle_id raises explicit error. Reuse FEATURE-KNOB / angle registry work if present.
...
`artifacts/coordination/handoffs/gt30d_d02_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-d02-code-terminal=<sha-or-blocked>
NEXT_ACTION=
```
