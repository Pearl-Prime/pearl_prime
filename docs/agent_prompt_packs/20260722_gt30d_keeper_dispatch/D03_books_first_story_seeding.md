# D03 — Cursor Dev Lane (I045)

EXECUTE. Act as Pearl_Dev on **Cursor**. Depends on **W0 only**.

## Goal

Books-first engine-keyed STORY seeding + 4-cell rebuild proof. Smoke→pilot only. Source: old_chat_specs export_366 closeout leftovers.
...
`artifacts/coordination/handoffs/gt30d_d03_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-d03-code-terminal=<sha-or-blocked>
NEXT_ACTION=
```
