# D08 — Cursor Dev Lane (I026) [SPEC-GATED]

EXECUTE. Act as Pearl_Dev on **Cursor**.

## Gate

Do not start until `C05` closeout shows `gt30d-c05-spec-terminal=<sha>`.

## Goal

Wire freebie selection from brand_wizard + musician survey YAML per C05. No hardcoded freebie lists.
...
`artifacts/coordination/handoffs/gt30d_d08_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-d08-code-terminal=<sha-or-blocked>
NEXT_ACTION=
```
