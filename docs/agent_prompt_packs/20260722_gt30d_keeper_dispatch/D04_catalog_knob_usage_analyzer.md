# D04 — Cursor Dev Lane (I007)

EXECUTE. Act as Pearl_Dev on **Cursor**. Depends on **W0 only**.

## Goal

Catalog knob usage-% analyzer. Extend scripts/audit/build_pipeline_matrix.py or add sibling — do not duplicate. Report per-knob usage for English catalog/planner.
...
`artifacts/coordination/handoffs/gt30d_d04_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-d04-code-terminal=<sha-or-blocked>
NEXT_ACTION=
```
