# C04 — Claude Spec Lane (I025+I048)

EXECUTE. Act as Pearl_Architect on **Claude**.

## Goal

MERGE into SPEC-1: add bridge/adjacency cohesion section (scene→story, story→exercise, data→teaching). No parallel taxonomy. Update SPEC_INDEX note if needed.

**Target path:** `docs/specs/session_mining_batch_20260718/ATOM_SURFACE_TAXONOMY_AND_VARIATION_MANIFEST_V1_SPEC.md`
...
`artifacts/coordination/handoffs/gt30d_c04_2026-07-22.md`
...
CLEANUP_COMPLETE=
HANDOFF=
SIGNAL=gt30d-c04-spec-terminal=<sha-or-blocked>
NEXT_ACTION=
```
