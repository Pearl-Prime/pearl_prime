...
**Cover assembly:** [Storyblocks Cover Assembly V1](./specs/STORYBLOCKS_COVER_ASSEMBLY_V1.md) — canonical licensed Storyblocks-first, exact-topic, fail-closed, CPU-only path and coverage gate.
...
| **Author/repair social media atoms (Pearl_Social_Media_Writer)** | Agent definition: [.claude/agents/pearl-social-media-writer.md](../.claude/agents/pearl-social-media-writer.md). Operating manual: [skills/pearl-social-media-writer/SKILL.md](../skills/pearl-social-media-writer/SKILL.md) — gap-finding audit method, compliant-row checklist, local CI gate, draft→promotion path. Authority: [docs/PEARL_SOCIAL_MEDIA_WRITER_AGENT_SPEC_2026-07-18.md](./PEARL_SOCIAL_MEDIA_WRITER_AGENT_SPEC_2026-07-18.md) (atom families, metadata schema, platform rules, `SOCIAL-ATOM-BANK-VIBE-01` brand/author extension). Current gap list: [docs/specs/SOCIAL_MEDIA_100PCT_PRODUCTION_PLAN_2026-07-22.md](./specs/SOCIAL_MEDIA_100PCT_PRODUCTION_PLAN_2026-07-22.md). Writes/repairs only `SOURCE_OF_TRUTH/social_media_atoms/*.jsonl` — never live publishing. |
...
| **Waystream EPUB render throughput (800-book wave)** | [docs/specs/WAYSTREAM_EPUB_RENDER_OPTIMIZATION_V1_PLAN.md](./specs/WAYSTREAM_EPUB_RENDER_OPTIMIZATION_V1_PLAN.md) — phased throughput plan: parallel workers (done), unified manuscript processor, atom preflight; evidence in [artifacts/qa/waystream_render_bottleneck_snapshot_20260622.md](../artifacts/qa/waystream_render_bottleneck_snapshot_20260622.md). |
...
| **Manga production operational (queue + GHA hybrid)** | [docs/specs/MANGA_PRODUCTION_OPERATIONAL_V1_SPEC.md](./specs/MANGA_PRODUCTION_OPERATIONAL_V1_SPEC.md) — Hybrid C scheduling: Pearl Star Procrastinate queue = canonical render path; GHA = trigger/digest with replay fallback; G1–G5 gates + Q-MPO-* defaults. Queue substrate: [docs/specs/PEARL_STAR_JOB_QUEUE_V1_SPEC.md](./specs/PEARL_STAR_JOB_QUEUE_V1_SPEC.md). |
...
| **Manga video pose-bank supply spec (V-Bank V1)** | [docs/specs/MANGA_VIDEO_POSE_BANK_SUPPLY_SPEC.md](./specs/MANGA_VIDEO_POSE_BANK_SUPPLY_SPEC.md) — capture→bank supply; schema [schemas/manga/character_capture_manifest.schema.json](../schemas/manga/character_capture_manifest.schema.json); tooling `scripts/manga/video_bank/`. |
| **Manga video pose-bank capability research (2026-07-24)** | [docs/research/MANGA_VIDEO_POSE_BANK_CAPABILITY_RESEARCH_2026-07-24.md](./research/MANGA_VIDEO_POSE_BANK_CAPABILITY_RESEARCH_2026-07-24.md) — free-tier + 16GB self-host matrix. |
...
| **Book cover — unified research + proposed spec (4-level uniqueness, platform gaps, templates, byline fix)** | [docs/authoring/BOOK_COVER_UNIFIED_RESEARCH_2026-07-01.md](./authoring/BOOK_COVER_UNIFIED_RESEARCH_2026-07-01.md) — Synthesis of the scattered cover research: existing-research inventory (landed vs aspirational), the 4-level (L1 Brand→L5 Platform) uniqueness model reconciling manga L1–L4 + book 4-slot, per-platform matrix + gap list (Kobo 3:4, audiobook 2400²/3000², web-revalidated 2026-07-01), free-template error-reduction playbook, and the teacher-vs-author byline fix (`scripts/release/build_epub.py` TEACHER_BOOKS). Read-only on render code (PR #4269 owns it); build lane in §7. |
| **Per-platform cover output profiles** | [config/publishing/platform_cover_profiles.yaml](../config/publishing/platform_cover_profiles.yaml) — per-target aspect/size/format/safe-area/max-MB + `launch_priority` (KDP=0, GooglePlay-ebook+Kobo=1, audiobook-square=2, rest=3). DATA ONLY, read by exporters (lanes 3-4, after PR #4269), not render code. Loader/validator [scripts/publishing/load_cover_profiles.py](../scripts/publishing/load_cover_profiles.py); test [tests/test_platform_cover_profiles.py](../tests/test_platform_cover_profiles.py). SSOT for values: [docs/authoring/BOOK_COVER_UNIFIED_RESEARCH_2026-07-01.md](./authoring/BOOK_COVER_UNIFIED_RESEARCH_2026-07-01.md) §3/§4. |
...
| **Social media atom-bank writer agent spec** | [docs/PEARL_SOCIAL_MEDIA_WRITER_AGENT_SPEC_2026-07-18.md](./PEARL_SOCIAL_MEDIA_WRITER_AGENT_SPEC_2026-07-18.md) — `Pearl_Social_Media_Writer` authority: 15 atom families, atom metadata schema, writing standard, per-platform rules (Instagram/LinkedIn/TikTok-Reels-Shorts/Pinterest/Facebook/X-Threads + JP/TW/KR/CN/HK/SG), weekly research-refresh design, draft→promotion outputs, `SOCIAL-ATOM-BANK-VIBE-01` brand/author-vibe extension. Agent + skill: [.claude/agents/pearl-social-media-writer.md](../.claude/agents/pearl-social-media-writer.md), [skills/pearl-social-media-writer/SKILL.md](../skills/pearl-social-media-writer/SKILL.md). Current layer-honest gap list: [docs/specs/SOCIAL_MEDIA_100PCT_PRODUCTION_PLAN_2026-07-22.md](./specs/SOCIAL_MEDIA_100PCT_PRODUCTION_PLAN_2026-07-22.md). SSOT: `SOURCE_OF_TRUTH/social_media_atoms/` (registry row `evergreen_social_atom_bank` in [artifacts/coordination/CANONICAL_ARTIFACTS_REGISTRY.tsv](../artifacts/coordination/CANONICAL_ARTIFACTS_REGISTRY.tsv)); subsystem row in [artifacts/coordination/SUBSYSTEM_AUTHORITY_MAP.tsv](../artifacts/coordination/SUBSYSTEM_AUTHORITY_MAP.tsv) (`social_media`, owner `Pearl_Social_Media_Writer`). |
...
| [GHL_ADMIN_HANDOFF_FREEBIE_CAPTURE.md](./GHL_ADMIN_HANDOFF_FREEBIE_CAPTURE.md) | Freebie funnel / Integrations | ✓ — Forward to GHL admin; inbound webhook for quiz capture |
