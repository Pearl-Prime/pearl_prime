...
| **Manga catalog/portfolio reconciliation (CANONICAL governance)** | [specs/MANGA_CATALOG_RECONCILIATION_SPEC.md](../specs/MANGA_CATALOG_RECONCILIATION_SPEC.md) — Phase 2X reconciliation spec (D-1..D-20); 7-PR migration sequence; 5-locale matrix (en_US/ja_JP/zh_TW/zh_CN/ko_KR per D-18); 15-genre strategic allow-list (§4.1); 37-brand portfolio (3 flagship × 16 + 16 core × 9 + 18 niche × 5 = 1,410 series); brand-vs-teacher resolution (OQ-3); zh_CN gray-zone routing (D-19); ko_KR hold (D-18); mass-deletion authority (D-20). |
