# Out-of-roster packs (wave 1)

These packs were authored for the launch-first topic set but sit **outside** the live roster defined in `pearl_news/config/teacher_news_roster.yaml`. They are preserved here for a future wave when roster is extended; they are **not** loaded for launch-first hard-news.
